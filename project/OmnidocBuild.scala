...
object OmnidocBuild {
  ...
  val playVersion              = sys.props.getOrElse("play.version",               "2.9.0-M3")
  val scalaTestPlusPlayVersion = sys.props.getOrElse("scalatestplus-play.version", "6.0.0-M3")
  val playJsonVersion          = sys.props.getOrElse("play-json.version",          "2.10.0-RC7")
