...
object OmnidocBuild extends Build {
  ...
  val playVersion       = sys.props.getOrElse("play.version",       "2.4.0-RC5")
  val anormVersion      = sys.props.getOrElse("anorm.version",      "2.4.0-RC3")
  val playEbeanVersion  = sys.props.getOrElse("play-ebean.version", "1.0.0-RC3")
  val playSlickVersion  = sys.props.getOrElse("play-slick.version", "1.0.0-RC3")
