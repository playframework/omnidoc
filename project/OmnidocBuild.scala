...
object OmnidocBuild {
  ...
  val playVersion              = sys.props.getOrElse("play.version",               "3.0.11")
  val scalaTestPlusPlayVersion = sys.props.getOrElse("scalatestplus-play.version", "7.0.2")
  val playJsonVersion          = sys.props.getOrElse("play-json.version",          "3.0.6")
