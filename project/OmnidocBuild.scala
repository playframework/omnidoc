...
object OmnidocBuild {
  ...
  val playVersion              = sys.props.getOrElse("play.version",               "2.8.0-RC2")
  val scalaTestPlusPlayVersion = sys.props.getOrElse("scalatestplus-play.version", "5.0.0-RC2")
  val playJsonVersion          = sys.props.getOrElse("play-json.version",          "2.8.0")
  val playSlickVersion         = sys.props.getOrElse("play-slick.version",         "5.0.0-RC2")
